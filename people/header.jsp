	...
	<table class="mainmenu" align="center">
		<c:if test="${empty loginUser}">
			<tr>
				...
				<td>	</td>
				<td class="login">
					<a name="login" href="#" style="text-decoration: none;"
					onclick="location.href='http://localhost:8181/web_project/index.jsp'"> 로그인 </a>
				</td>
			...
			<tr>
				...
				<c:choose>
					<c:when test="${result==2}">
						<td class="login">
							<a href="customjoin.do" style="text-decoration: none"> 사원등록 </a>
						</td>
					</c:when>
				...
				<td class="login">
					<a href="customDelete.do" style="text-decoration: none"> 회원탈퇴 </a>
				</td>
				<td class="login">
